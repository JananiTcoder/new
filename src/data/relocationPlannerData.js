...
export const EMERGENCY_COORDINATORS = [
  {
    ...
    location: 'Tambaram',
    district: 'Tambaram / Coastal District',
    distanceKm: 3.2,
    distanceText: '3.2 km',
    status: 'Available',
  ...
  },
  {
    ...
    designation: 'Zonal Incident Commander',
    location: 'Velachery',
    district: 'Velachery / Central District',
    distanceKm: 5.1,
    distanceText: '5.1 km',
    status: 'Available',
    currentAssignment: 'Standby / Zonal Operations',
    contactChannel: 'VHF Ch 3 · Command Channel',
    phone: '+91 98402 11223',
    experience: '10 years civil defense',
    position: { lat: 12.9815, lng: 80.218 }, // Velachery
  },
  {
    id: 'coord-bose',
    name: 'A. Bose',
...
export const NEARBY_VOLUNTEERS = [
  ...
  },
  {
    id: 'vol-divya',
    name: 'Divya Rajan',
    capability: 'Evacuation Support',
    skill: 'Evacuation Support',
    location: 'Pallavaram',
    district: 'Central District',
    distanceKm: 5.6,
    distanceText: '5.6 km',
    status: 'Available',
    currentAssignment: 'Supply & Evacuation Standby',
    certifications: ['Disaster Relief Logistics Specialist'],
    contactChannel: 'Phone / VHF Ch 2',
    phone: '+91 97910 11423',
    position: { lat: 12.9675, lng: 80.1491 }, // Pallavaram
  },
  {
    id: 'vol-priya',
    name: 'Priya Srinivasan',
    capability: 'Shelter Logistics & Management',
    skill: 'Logistics',
    ...
    distanceText: '2.8 km',
    status: 'Available',
    currentAssignment: 'Shelter In-Take Officer',
    certifications: ['Disaster Management Certified', 'Logistics Lead'],
    contactChannel: 'Phone / VHF Ch 4',
    phone: '+91 97910 99312',
    position: { lat: 12.901, lng: 80.2279 }, // Sholinganallur
  },
  {
    id: 'vol-arjun',
    name: 'Arjun Kumar',
