...
export const navItems = [
  ...
  { id: 'sites', label: 'Relief Sites', path: '/app/relief-sites', icon: 'ShieldCheck' },
...
// Disaster Authority gets exactly these six primary tabs, in this order:
// Overview, Risk Habitations, Operation Management, Alerts, Audit Trail, Settings
const AUTHORITY_TAB_IDS = ['overview', 'habitations', 'operations', 'alerts', 'audit', 'settings']

// Citizen gets exactly these seven tabs, in this order
const CITIZEN_TAB_IDS = ['overview', 'sites', 'routes', 'alerts', 'report-issue', 'emergency-sos', 'settings']

// Volunteer gets these tabs
...
// Emergency Coordinator gets these tabs
const COORDINATOR_TAB_IDS = ['overview', 'hazard', 'habitations', 'sites', 'resource-network', 'routes', 'evacuation', 'whatif', 'alerts', 'settings']
